        ...
        <div class="img">
            ...
            <div class="login">
                <form action="#" method="POST">
                    <h2>Entrar como utilizador</h2>
                    <div class="inputbox">
                        <input type="name" name="username" id="username" placeholder="Nome de utilizador" onkeyup="validateUsername()">
                    </div>
                    ...
                    <p>Pretende iniciar como admin? <a href="../templates/adminlogin.php">Entre aqui!</a></p>
                </div>
                </form>
            </div>
        </div>
